      ...
      <header className="flex h-14 shrink-0 items-center gap-4 border-b border-border bg-sidebar px-4">
        ...
        <div className="ml-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-border pl-4">
            <span className="rounded border border-amber-500/50 px-2 py-1 text-[11px] font-semibold text-amber-700 dark:text-amber-300" title="Los nodos, relaciones, ambientes y métricas son datos ilustrativos">DEMO · Datos ilustrativos</span>
